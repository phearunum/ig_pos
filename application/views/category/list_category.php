...
<html>
    ...
    <body>
        ...
        <div class="container-fluid container-fluid-custom">
            <!-- <?php if ($p->permission_add != 0) { ?> --><a class="btn btn-primary pull-right <?php echo $permission_add;?>" href='<?php echo site_url("category/addnew"); ?>'><i class="fa fa-plus"></i> <?php  echo $lbl_new; ?></a><!-- <?php } ?> -->
            ...
            <table width="100%" cellspacing="0" class="table-table" id="table-table" cellpadding="0" border="0">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th><?php echo $lbl_category_name; ?></th>
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    var t = $('#table-table').DataTable({
                        "bProcessing": false,
                        "sAjaxSource": "<?php echo site_url("category/response"); ?>",
                        "aoColumns": [
                            {mData: 'category_id'},
                            {mData: 'category_name'},
                            {mData: 'category_description'},
                            {mData: 'category_created_date'},
                            {mData: 'recorder'},
                ...
                $('#table-table').on('click', 'td .delete', function (e) {
                    ...
                    var href = '<?php echo site_url("category/delete") ?>' + "/" + id;
                ...
                $('#table-table').on('click', 'td .edit', function (e) {
                    e.preventDefault()
                    var id = $(this).closest('tr').find('td:first').html();
                    var href = '<?php echo site_url("category/edit_load") ?>' + "/" + id;
                    //  $('a.delete', $(this)).attr('href', href);
                    window.location.href = href;
                });
            });
