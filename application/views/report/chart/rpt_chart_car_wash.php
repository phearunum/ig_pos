<html>
    ...
    <body>
        <form action="<?php echo site_url("report_chart_car_wash/search") ?>" method="post">
            ...
            <div>
                <p style="font-size: 25px; text-align: center; text-decoration: underline; font-weight: bold">The Most Sale Product In Car Care</p>
