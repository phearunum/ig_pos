...
<html>
    ...
    <body>
        ...
        <div class="container-fluid container-fluid-custom">
            ...
            <h3 class="text-center text-primary"><?php echo "Report Sale Costing and Margin"?></h3>
        <table width="100%" cellspacing="0" class="table-table" id="table-table" cellpadding="0">
            <thead>
                <tr>
                    ...
                    <th><?php echo "Total Costing"?></th>
                    <th><?php echo "Total Margin"?></th>
...
<script type="text/javascript">
    ...
    $(document).ready(function (){
        var data_table=$('#table-table').DataTable({
            "bProcessing": false,
            "sAjaxSource": '<?php echo site_url("report_sale_summary_margin/response"); ?>',
            "aoColumns": [
           ...
           "aoColumnDefs": [
                ...
                { "width": "50px", "targets": [1,7,8] },        
                { "width": "130px", "targets": [4,5] },     
                { "width": "80px", "targets": [6,9,10,11] }     
           ],
           "order": [[1, 'desc']],
            "footerCallback": function (nRow) {
                ...
                total_costing_all = api.column(10, {
                    page: 'all'
                })
                .data()
                .reduce(function (total, b) {
                ...
                total_margin_all = api.column(11, {     
                    page: 'all'     
                })      
                .data()     
                .reduce(function (total, b) {       
                ...
                nCells[10].innerHTML = total_costing.toFixed(dot_num)+' of '+total_costing_all.toFixed(dot_num);
                nCells[11].innerHTML = margin.toFixed(dot_num)+' of '+total_margin_all.toFixed(dot_num);
            }
        });
        ...
        $("#form-search").on('submit',function(e){
            ...
            var url = '<?php echo site_url("report_sale_summary_margin/responses");?>';
