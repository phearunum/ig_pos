...
<html>
    ...
    <body>
        ...
        <div class="container-fluid container-fluid-custom">
                ...
                <div class="col-md-12">
                    <div class="form-group cs-group">
                      <div class="col-sm-2 col-xs-6 col-cs">
                        <input type="text" class="form-control" placeholder="CREDIT FROM" name="datefrom" id="datefrom" autocomplete="off">
                      </div>
                      <div class="col-sm-2 col-xs-6 col-cs">
                        <input type="text" class="form-control" placeholder="CREDIT TO" name="dateto" id="dateto" autocomplete="off">
                      </div>
                      <div class="col-sm-2 col-xs-6 col-cs">
                        <input type="text" class="form-control" placeholder="PAID FROM" name="paidfrom" id="paidfrom" autocomplete="off">
                      </div>
                      <div class="col-sm-2 col-xs-6 col-cs">
                        <input type="text" class="form-control" placeholder="PAID TO" name="paidto" id="paidto" autocomplete="off">
                      </div>
                      <div class="col-sm-2 col-xs-6 col-cs">
                      ...
                      <div class="col-sm-2 col-xs-6 col-cs">
                        <select name="agency" id="agency" class="form-control">
                            ...
                            <?php
                                foreach($records_agency as $ra){
                            ?>
                                <option value="<?php echo $ra->layout_id; ?>"><?php echo $ra->layout_name; ?></option>
                            <?php
                              }
                            ?>
                        </select>
                      ...
                      <div class="col-sm-1 col-xs-6 col-cs">
                        <button type="button" class="btn btn-success btn-block" name="btn_pay"  id="btn_pay" ><i class="fa fa-credit-card"></i> Pay</button>
                      </div>
            ...
            <h3 class="text-center text-primary"><?php echo "Report Sale Credit";?></h3>
...
<script type="text/javascript">
    ...
    $("#paidfrom").datepicker({dateFormat: 'yy-mm-dd', showButtonPanel: true});
    $("#paidto").datepicker({dateFormat: 'yy-mm-dd', showButtonPanel: true});
    $(document).ready(function (){

        var data_table=$('#table-table').DataTable({
            "bProcessing": true,
            "sAjaxSource": '<?php echo site_url("Report_sale_credit/response"); ?>',
            "aoColumns": [
                ...
                {mData: "paid"},
                // {mData: 'branch_name'},
                {mData: "sale_master_status",mRender:function ( data, type, row ){
                    if(data==3){
                        return "<h5>CREDIT</h5>";
                    }
                    if(data==4){
                        return "<h5 style='background:#007aff;'>"+row.sale_master_modified+"</h5>";
                    }
                }},
            ],
           "iDisplayLength": 50,
        ...
        $("#form-search").on('submit',function(e){
            ...
            var url = '<?php echo site_url("Report_sale_credit/responses");?>';
        ...
        $("#btn_pay").on('click',function(e){
            ...
            var master_ids  =  $('#table-table tbody td:nth-child(1)').map(function(){
                    return $(this).text();
                }).get();
            if (confirm('Do you want to pay??')) {
                $.ajax({
                    type: 'POST',
                    url: 'report_sale_credit/update',
                    data:{master_ids:master_ids},
                    success: function (data) {
                        alert("Record Payment Done.");
                        $("#btn_search").click();
                    }
                });
            }
...
<script type="text/javascript">
    ...
    // });
    function print_date(){
		var post_url = "<?php echo site_url("Report_sale_credit/order_list_cash_out")?>";
	...
	function myprint(final,print_date){
            ...
            setTimeout(function(){
                if(print_date==true){
                   ...
                   window.open("<?php echo site_url("report_sale_credit"); ?>",'_self');
            }, 300);
