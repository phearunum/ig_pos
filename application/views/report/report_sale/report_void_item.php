...
<html>
    ...
    <body>
        ...
        <form class="formSale" id="form">
                <div class="col-md-12">
                    <div class="form-group cs-group">
                      ...
                      <div class="col-sm-2 col-xs-6 col-cs" hidden>
                        <input type="text" class="form-control text_input" name="txt_seller_name" id="txt_seller_name" autocomplete="off" placeholder="SEARCH SELLER">
            ...
            <h3 class="text-center text-primary"><?php echo "Report Void Item List"?></h3>
        ...
        $(document).ready(function(){
            var data_table=$('#table-table').DataTable({
                "bProcessing": false,
                "sAjaxSource": "<?php echo site_url("report_void_item/response/"); ?>",
                "aoColumns": [
                    {mData: 'invoice_no'},
                    {mData: 'customer_name'},
                    {mData: 'checkout_date'},
                ...
                "drawCallback": function ( settings ) {
                    ...
                    api.column(12, {page:'current'} ).data().each( function ( group, i ) {
                        ...
                        if ( last !== group ) {
                            ...
                            var dataGroup='<tr class="group"><td colspan="11">'+rowData+'</td><td></td></tr>';
                            j=j+1;
                            if(j!=1){
                                var dataGroupTotal='<tr class="group_footer"><td colspan="2"><?php echo $lbl_sub_total;?> :</td><td></td><td></td><td class="'+data_group[i-1]+'_qty"></td><td></td><td class="'+data_group[i-1]+'_Total"></td><td class="'+data_group[i-1]+'_Discount"></td><td class="'+data_group[i-1]+'_Tax"></td><td class="'+data_group[i-1]+'_Grand"></td><td></td><td></td></tr>';
                    ...
                    $(rows).eq(CategoryLeng-1).after('<tr class="group_footer"><td colspan="2"><?php echo $lbl_sub_total;?> :</td><td></td><td></td><td class="'+data_group[CategoryLeng-1]+'_qty"></td><td></td><td class="'+data_group[CategoryLeng-1]+'_Total"></td><td class="'+data_group[CategoryLeng-1]+'_Discount"></td><td class="'+data_group[CategoryLeng-1]+'_Tax"></td><td class="'+data_group[CategoryLeng-1]+'_Grand"></td><td></td><td></td></tr>');
            ...
            $("#form").on('submit', function (e) {
                e.preventDefault();
                var url  = '<?php echo site_url("report_void_item/responses"); ?>';
