...
<html>
    ...
    <body>
        ...
        <div class="container-fluid container-fluid-custom">
            <form class="formSale" id="form" method="POST">
                <div class="col-md-12">
...
<!--                      <div class="col-sm-2 col-xs-6 col-cs">
                      ...
                      <div class="col-sm-2 col-xs-6 col-cs">
                        <select class="form-control" name="cbo_recorder" id="cbo_recorder" >
                            ...
                            <?php foreach ($data_cashier as $val){?>
                            <option value="<?=$val->employee_id?>"><?=$val->cashier?></option>
                             <?php  } ?>
                        </select>
 ...
 -->
            ...
            <h3 class="text-center"> <?php echo "Report Cash Register" ?></h3>
            <table width="100%" cellspacing="0" class="table-table" id="table-table" cellpadding="0">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th><?php echo "Cashier Name" ?></th>
                        <th><?php echo "Start Date" ?></th>
                        <th><?php echo "End Date"?></th>
                        <th><?php echo "Start Amount" ?></th>
                        <th><?php echo "Sale Amount" ?></th>
                        <th><?php echo "Total Amount" ?></th>
                        <th><?php echo "Real Cash" ?></th>
                    </tr>
                </thead>
                <tbody></tbody>
                <tfoot>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var table = $('#table-table').DataTable({
                ...
                "bProcessing": false,
                "scrollX": true,
                "sAjaxSource": "<?php echo site_url("report_cash_register/response"); ?>",
                "aoColumns": [
                    {mData: 'cash_id'},
                    {mData: 'cashier'},
                    {mData: 'start_date'},
            ...
            $("#form").on('submit', function (e) {
                e.preventDefault();
                 var data = $(this).serialize();
                    var url = '<?php echo site_url("Report_cash_register/responses_search")?>';
                    table.clear().draw();
