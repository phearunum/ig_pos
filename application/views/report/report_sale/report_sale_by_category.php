...
<script type="text/javascript">
    $(document).ready(function () {
        var data_table=$('#table-table').DataTable({
            "bProcessing": false,
            "sAjaxSource": "<?php echo site_url("report_sale_by_category/response/"); ?>",
            "aoColumns": [                
            ...
            "iDisplayLength": 50,
            "columnDefs": [
                {"visible": false, "targets": [0,8]}// To hidden item_type_id
            ],
            "order": [[0, 'asc']],
            "displayLength": 25,
            "drawCallback": function ( settings ) {
                    ...
                    api.column(8, {page:'current'} ).data().each( function ( group, i ) {
                        ...
                        if ( last !== group ) {
                            ...
                            ///
                            var rowData = api.column(0,{page:'current'}).data()[i];
                            var dataGroup='<tr class="group"><td colspan="2">'+rowData+'</td><td></td><td></td><td></td><td></td><td></td></tr>';
                            j=j+1;
                            if(j!=1){
        ...
        $("#form").on('submit', function (e) {
            ...
            var url  = '<?php echo site_url("report_sale_by_category/responses?"); ?>';
