                        ...
                        <div class="col-md-12">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="hidden" name="txt_user_id" id="txt_user_id" required value="<?php echo $ru->user_id ?>">
                                    <label><?php echo $lbl_user_employee_name; ?>:<span class="star"> *</span></label>
                                    <select name="cbo_employee_name" id="cbo_employee_name" class="form-control form-custom">
                                             <option value="0">--Employee Name--</option>
                                        <?php
                                            foreach($record_employee as $re){
                                                if($ru->employee_id == $re->employee_id){
                                                    echo "<option selected value='$re->employee_id'>$re->employee_name</option>";
                                                }else{
                                                    echo "<option value='$re->employee_id'>$re->employee_name</option>";
                                                }
                                        ?>
                                        <?php
                                          }
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-custom text_input" type="text" name="txt_username" id="txt_username" value="<?php echo $ru->user_name ?>" required>
                                    <div class="border"></div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-custom text_input" type="password" name="txt_password" id="txt_password" value="<?php echo $password  ?>" required>
                                    <div class="border"></div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="cbo_printer_location_name" id="cbo_printer_location_name" class="form-control form-custom">
                                       <!--  <option value="0">--Printer Location Name--</option> -->
                                        <?php
                                            foreach($record_printer_location as $rp){
                                                if($ru->user_printer_location_id == $rp->printer_location_id){
                                                    echo "<option selected value='$rp->printer_location_id'>$rp->printer_location_name</option>";
                                                }else{
                                                    echo "<option value='$rp->printer_location_id'>$rp->printer_location_name</option>";
                                                }
                                        ?>
                                        <?php
                                            }
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                   ...
                                   <input type="text" name="txt_note" id="txt_note" class="form-control form-custom text_input" value="<?php echo $ru->user_note ?>">
                                   <div class="border"></div>
                                </div>
                            </div>
                             <div class="col-sm-12 <?php if($is_supper_user!='true') echo ' hidden '; ?>">
                                <div class="form-group">
                                   ...
                                   <input  value="<?=$ru->is_supper_user;?>" type="checkbox" name="ch_user" id="ch_user" >
                                </div>
                            </div>
                        </div>
                    </div>
