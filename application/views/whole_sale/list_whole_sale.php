    ...
    <body>
        ...
        <table width="100%" cellspacing='0' id="table2excel" cellpadding='0' border='0' class="table-table  persist-area">
            <tr style="height: 30px;" class="persist-header">
                    <th width='2%'><a href="<?php echo site_url("whole_sale/addnew"); ?>">New</a></th>
                    <th width='3%'>NO</th>
                    <th width='7%'>Invoice W#</th>
                    <th width='9%'>Customer Name</th>
                    <th width='7%'>Recorder</th>
                    <th width='5%'>Seller</th>
                    <th width='9%'>Date of Buy</th>
                    <th width='5%'>Hour</th>
<!--                <th>Due Date</th>-->
                    <th width='5%'>Total</th>
                    <th width='5%'>Dis(%)</th>
                ...
                ?>
                <tr>
                    <td><a href="<?php echo site_url("whole_sale/load_sale_detail_list/".$rss->sale_master_invoice_no) ?>"><img src="<?php echo base_url("img/icons/view.png"); ?>"></a></td>
                    <td><?php echo $no?></td>
                    <td>
                        <?php
            ...
            <div class="modal-dialog">
                    <div class="modal-content">
                            ...
                            <div class="modal-body">							
                                <form action="<?php echo site_url("whole_sale/search") ?>" method="post">
