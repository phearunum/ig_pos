...
<form class="formSale" action="<?php echo site_url("whole_sale/submit"); ?>" method="POST" id="form">
    <table width="100%" cellspacing="0" cellpadding="0" border="1" class="table-form">
        <tr class="field-title">
            <td colspan="3" style="text-align: center;font-size: 20px;font-weight: bold;">WHOLE SALE</td>
        </tr>
        <tr>
                            ...
                            <table width="100%" border="1" class="table-table">          
                                                ...
                                                ?>
                                                    <tr style="color:#000000">
                                                        ...
                                                        <td><?php echo number_format($g->sale_detail_discount_percent,2) ?></td>
                                                        <td><?php echo number_format($g->sale_detail_total-(($g->sale_detail_total*$g->sale_detail_discount_percent)/100),2) ?></td>
                                                        <?php
                                                            //if($p->edit!=0){
                                                        ?>
                                                        <td>
                                                            <a href="<?php echo site_url("whole_sale/edit_load/".$g->sale_detail_id."/".$g->sale_detail_item_id."/".$g->measure_id.'/'.'active') ?>">Edit</a>
                                                        </td>
                                                        <?php
                                                            //}
                                                            //if($p->delete!=0){
                                                        ?>
                                                        <td width="50px"><a href="<?php echo site_url('whole_sale/delete/' . $g->sale_detail_id."/".$g->sale_detail_item_id."/".$g->sale_detail_qty."/".$g->measure_id); ?>" onclick="return confirm('Do you want to delete this record?')">
