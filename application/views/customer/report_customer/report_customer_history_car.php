...
<html>
		...
		<script type="text/javascript">
			...
			exclude_inputs: true
               ...
               if (str == "") {
                    ...
                    xmlhttp.open("POST","report_customer_history_car/search/"+customer,true);
                    xmlhttp.send();
                }
            }
	...
	<body>
		...
		<table class="table-form" style="width: 100%">
			...
			<tr>
                            <td class="form-title text-center" colspan="12" >Report Customer History ( Car Care )</td>
			</tr>
                        <tr>
                                    ...
                                    foreach ($customer_name as $cn) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <table>   
                                                    <?php
                                                    $invoice_no = $this->Base_model->loadToListJoin("SELECT customer,customer_id,invoice_no,car_care FROM v_customer_history where car_care = 1 and customer <> '' and customer_id = " . $cn->customer_id . " GROUP BY invoice_no ORDER BY invoice_no DESC");
                                                    foreach ($invoice_no as $in) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align: left; padding-left: 10px; width:400px" >
                                                                ...
                                                                $itno = 1;
                                                                $sub_total = 0;
                                                                $item_name = $this->Base_model->loadToListJoin("SELECT invoice_no,item_name,grand_total,car_care FROM v_customer_history where car_care = 1 and  customer <> '' and invoice_no = " . $in->invoice_no);
    ...
    <?php } ?>
                                            ...
                                            <td>
                                                <?php
                                                $total = 0;
                                                $grand_total_name = $this->Base_model->loadToListJoin("SELECT sum(grand_total) as grand_total,car_care FROM v_customer_history where car_care = 1 and  customer <> '' and customer_id = " . $cn->customer_id . " GROUP BY customer_id");
