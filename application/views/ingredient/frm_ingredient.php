                    ...
                    <table width="100%" class="table-form">
                        ...
                        <tr>
                            <td style="text-align: right" colspan="2">
                                <input type="button" name="btnSave" id="btnSave" value="<?php echo $btn_save;?>" class="btn btn-primary"/>
                            </td>
                        </tr>
                        </table>
        ...
        $('#txt_ingredient').autocomplete({
                ...
                change:function(event,ui){
                    if(ui.item===null){
                        ...
                        $("#lbl_measuer").text("Ingredient Measure : "+names[3]);
                    }
                }   	
            });
...
//          }
        ...
        function edit(inc,inc_name,qty,n,descrip){
        ...
        function add(){
            ...
            var edit_del='<td class="text-center"><a onclick="edit('+inc+','+"'"+inc_name+"'"+','+qty+','+rowCount+','+"'"+dec+"'"+')" class="btn btn-info btn-xs" href="javascript:void(0)"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a> <a onclick="del('+inc+')" href="javascript:void(0)" class="btn btn-danger btn-xs"><i class="fa fa-trash-o" aria-hidden="true"></i> Del</a></td>';
            ...
            if(id_edit==""){
                ...
                $('#table-table').append('<tr id="row'+inc+'"><td class="hidden inc">'+inc+'</td><td>'+rowCount+'</td><td>'+inc_name+'</td><td>'+qty+'</td>'+'<td>'+dec+'</td>'+edit_del+'</tr>');
                clear();
                ...
                $('#table-table').find('#row'+id_edit+'').replaceWith('<tr id="row'+inc+'"><td class="hidden inc">'+inc+'</td><td>'+rowCount+'</td><td>'+inc_name+'</td><td>'+qty+'</td>'+'<td>'+dec+'</td>'+edit_del+'</tr>');
                    clear();
            }
