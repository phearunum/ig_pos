                      ...
                      <div class="col-md-12">
                          <div class="col-sm-6">
                              <div class="form-group">
                                  ...
                                  <input class="form-control form-custom text_input" type="text" name="txt_product_name" id="txt_product_name" autocomplete="off" placeholder="<?=$lbl_stock_itemName?>">
                                  <div class="border"></div>
                              </div>
                          </div>
                      </div>
                      <div class="col-md-12">
                          <div class="col-sm-6">
                              <div class="form-group">
                                  ...
                                  <input class="form-control form-custom text_input" type="text" name="txt_qty" id="txt_qty" autocomplete="off" placeholder="<?php echo $lbl_stock_QTY ?>">
                                  <div class="border"></div>
                              </div>
                          </div>
                      </div>
                          ...
                          <div class="col-sm-6">
                              <div class="form-group">
                                  ...
                                  <select name="cbo_stock_location" id="cbo_stock_location" class="form-control form-custom">                        
                                    <option value="0" selected><?php echo $lbl_allstock ?></option>
        ...
        <script type="text/javascript">
          $('form').on('submit',function(e){
            ...
            if(confirm('Are you sure to save it?')){
                $.ajax({
                  url:'<?php echo site_url('stock/save_waste')?>',
                  type:'post',
                  data:$('form').serialize(),
                  async:true,
                  success:function(req){
                    ...
                    if(json.status=='E001'){
                      ...
                      alert(json.message);
                      location.href='<?php echo site_url('stock/waste_list')?>';
                    }
                  }
              });
            }
