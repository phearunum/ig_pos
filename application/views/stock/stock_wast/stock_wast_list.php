    ...
    <head>
        ...
        <script>
            ...
            function save_edit(){
                ...
                $.ajax({
                    url:'<?php echo site_url('stock/stock_waste_update')?>',
                    type:'post',
            ...
            <form class="formSale" id="form">
                <div class="col-md-12">
                    <div class="form-group cs-group">
                      ...
                      <div class="col-sm-1 col-xs-6 col-cs">
                        <?php if ($p->permission_add != 0) { ?><a class="btn btn-primary btn-block" href='<?php echo site_url("stock/waste"); ?>'><i class="fa fa-plus"></i> <?php echo $lbl_new ?></a><?php } ?>
                      </div>
                     <div class="clearfix"></div>
                    </div>
                </div>
            </form>
            <h4 class="text-center"><?php echo $lbl_stock_waste_list_title;?></h4>
            <table width="100%" cellspacing="0" class="table-table" id="table-table" cellpadding="0">
                <thead>
                    <tr>
                        <th></th>
                        <th><!-- <a href="<?php echo site_url("stock/adjust"); ?>"><?php echo $lbl_new ?></a> --></th>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                var data_table = $('#table-table').DataTable({
                    "bProcessing": true,
                    "sAjaxSource": "<?php echo site_url("stock/response_stock_waste"); ?>",
                    "aoColumns": [
                        {mData: 'stock_waste_id'},
                        {"sTitle": "", "sDefaultContent": ''},
                        //LOAD ROW
                        {mData: 'item_detail_part_number'},
                        {mData: 'item_detail_name'},
                        {mData: 'stock_waste_qty'},
                        {mData: 'branch_name'},
                        {mData: 'stock_location_name'},
                        {mData: 'stock_waste_note'},
                        {mData: 'date_entry'},
                        {mData: 'recorder'},
                        {"sTitle": "<?php echo $lbl_edit ?>", "sDefaultContent": '<?php if ($p->permission_edit != 0) { ?><a href="#" class="edit"><img src="<?=base_url('img/settings/edit.svg')?>"></a><?php } ?>'},
                        {"sTitle": "<?php echo $lbl_delete ?>", "sDefaultContent": '<?php if ($p->permission_delete != 0) { ?><a href="#" class="delete"><img src="<?=base_url('img/settings/delete.svg')?>"></a><?php } ?>'}
                                        //END LOAD ROW
                    ],
                    "aaSorting": []
                    ,"aoColumnDefs": [
            ...
            $('#table-table').on('click', 'td .delete', function (e) {
                ...
                var href = '<?php echo site_url("stock/delete_stock_waste") ?>' + "/" + id;
            ...
            $("#form").on('submit', function (e) {
                ...
                var url = '<?php echo site_url("stock/search_stock_waste?"); ?>' + 'df=' + df + '&dt=' + dt+'&branch='+branch+'&stock='+stock+'&part='+part+'&item='+item;
