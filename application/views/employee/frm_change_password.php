...
<html>
    ...
    <body>
        <form class="frm" action="<?php echo site_url('employee/update_password_change'); ?>" method="post">
        <?php
        ...
        <table border="1" cellspacing="0" class="table-form" cellpadding="0" width="80%" align="center">
            ...
            <tr>
                ...
                <td><input type="password" name="txt_password" id="txt_password" required value="<?php echo $password ?>"></td>
            </tr>
            <tr class="field-title">
                <td colspan="2" style="text-align: right">
                    <button class="btn-srieng" type="submit">Update</button>
                    <button class="btn-srieng" id="btn-cancel" type="reset">Cancel</button>
                </td>
            </tr>
        </table>
    <?php
