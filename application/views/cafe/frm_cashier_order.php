...
<html class="no-js" lang="en">
    <head>
        ...
        <link href="<?php echo base_url(); ?>css/cafe/bootstrap-toggle.min.css" rel="stylesheet">
        <script src="<?php echo base_url(); ?>bootstrap-toggle.min.js"></script>
    ...
    body
    {
        ...
        <style>
           ...
           .item{
            height: 30px;
            font: 14px "Highpoint",'Arial' !important;
            line-height: 16px;
        ...
        <script type="text/javascript">
            ...
            $( document ).on( "ready", function(){
                if($("#txt_master_id").val()!=""){
                    check_old_new_item_order();
                }               
           });
            //SYSTEM CONFIG
            const allow_stock_qty_under_zero = true;
            // END SYSTEM CONFIG

            //SETTING
            const second_display=false;
            const display_enabled=true;
            const required_order=true;
            const auto_note=true;
            const member_card=false;
            const use_main_category = true;
            //END SETTING
    ...
    <body>
     <input type="text" hidden name="txt_old_item_order" id="txt_old_item_order">
     <input type="text" hidden name="txt_new_item_order" id="txt_new_item_order">
...
<!-- marge -->
        ...
        <!--Customer count-->
        <div class="modal_form" id="modal-customer-count">
            <div class="modal-dialog modal-count-lg" style="width: 275px !important;">
                <div class="modal-content">
                    <div class="modal-header" style="background: #13224b;color: white;font-weight: bold;">
                        <button type="button" class="close" id="btn-customer-count-close1" onclick="closeModal('modal-customer-count')" aria-hidden="true">&times;</button>
                        <h4 class="modal-title">Pax Number</h4>
                    </div>
                    <div class="modal-body">
                        <form id="form-customer-count" action="<?php echo site_url('cashier_order/save_pax'); ?>" method="post" enctype="multipart/form-data">
                        <!-- Tab Panel -->
                        <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="calculator calculator-sear  col-md-4 col-sm-4" style="margin-left: -30px;">
                                    <div class="calc-row">
                                        <input class="input-sad screen form-control" id="cust" name="cust" type="text" placeholder="" required style="width: 72%;margin-left: 38px;">
                                    </div>
                                    <div class="calc-row" style="margin-top:5px;">
                                        <input type="button" class="button button-sear-cal trigger-sear btn-keypaid" style="width:180px !important;" value ="C">
                                    </div>
                                    <div class="calc-row" style="height:58px;">
                                        <input type="button" class="button button-sear-cal trigger-sear btn-keypaid" style="margin: 8px;" value ="7" ><input type="button" class="button button-sear-cal trigger-sear btn-keypaid" style="margin: 8px;" value ="8" ><input type="button" class="button button-sear-cal trigger-sear btn-keypaid" style="margin: 8px;" value ="9">
                                    </div>
                                    <div class="calc-row" style="height:58px;">
                                        <input type="button" class="button button-sear-cal trigger-sear btn-keypaid" style="margin: 8px;" value ="4" ><input type="button" class="button button-sear-cal trigger-sear btn-keypaid" style="margin: 8px;" value ="5" ><input type="button" class="button button-sear-cal trigger-sear btn-keypaid" style="margin: 8px;" value ="6">
                                    </div>
                                    <div class="calc-row" style="height:58px;">
                                        <input type="button" class="button button-sear-cal trigger-sear btn-keypaid" style="margin: 8px;" value ="1" ><input type="button" class="button button-sear-cal trigger-sear btn-keypaid" style="margin: 8px;" value ="2" ><input type="button" class="button button-sear-cal trigger-sear btn-keypaid" style="margin: 8px;" value ="3" >
                                    </div>
                                    <div class="calc-row" style="height:58px;">
                                        <input type="submit" class="button button-sear-cal trigger-sear" id="btn_customer_count" style="margin: 8px;width:116px !important;" value ="Save" ><input type="button" class="button button-sear-cal trigger-sear btn-keypaid" style="margin: 8px;" value ="0" >
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger btn-md btn-autosize" onclick="closeModal('modal-customer-count')" style="background-color: #870413;" id="btn-customer-count-close2">Close</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12" id="navigate_left" style="padding-left: 0;padding-right: 0">
            ...
            <div class="col-lg-5 col-md-6 col-sm-6">
                <div class="row">
                    ...
                    <button class="btn btn-primary" type="button" onclick="table_order()" style="border-radius: 0px 0 30 0px;margin-left: -13px;"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;Back</button>
                         <button class="btn btn-danger" type="button" onclick="openModal('frm_sale_return')" style="border-radius: 0px 0 30 0px;"><i class="fa fa-level-down"></i>&nbsp;&nbsp;Return</button>

                         <button id="btn_edit_pax" class="btn btn-danger" type="button" onclick="openModal('modal-customer-count')" style="border-radius: 0px 0 30 0px;display:none;"><i class="fa fa-edit"></i>&nbsp;&nbsp;Pax</button>
                         <button class="btn" id="btn_split_note" type="button" onclick="plit_order_note(this)" style="border-radius: 0px 0 30 0px;"><i class="fa fa-scissors"></i>&nbsp;&nbsp;Split Note</button>
                         <input type="hidden" name="txt_split_note" id="txt_split_note" value="false">

                        <label id="table_name" style="float: right;font-weight: bold;"></label>
                        <div class="row" style="margin-left: -28px; margin-right: -15px;">
                            <style type="text/css">
                            ...
                            <table class="table_order" style="min-width: 400px">
                                <thead>
                                    <tr style="background-color: #13224b; margin:0;padding: 0;visibility: collapse; ">
                                        <!-- <th id="th1" style="width: 40px;"><input type="checkbox" class="check-box-main" value="1111" id="check-box-all" style="margin-left: 10px;"></th> -->
                                        <th id="th2" style="width: 129px text-align:left;">Item</th>
                                        <th id="th3" style="width: 50px">Price</th>
                                        <th id="th4" class="text-center" style="width: 80px">Unit</th>
                                        <th id="th5" style="width: 59px;">Dis(%)</th>
                                        <th id="th6" style="width: 51px;">Dis($)</th>
                                        <th id="th7" style="width: 56px;text-align: right;padding-right: 10px;">Amount</th>
                                ...
                                <div id="panel_order">
                                    <table id="table_order" class="table_order" style="min-width: 400px">
                                        <thead style="/*visibility: collapse;*/">
                                            <tr style="background-color: #38a049;">       
                                                <th id="th1" style="width: 40px;"><input type="checkbox" class="check-box-main" value="1111" id="check-box-all" style="margin-left: 10px;"></th>
                                                <th id="thh2" style="width: 129px text-align:left;">Item</th>
                                                <th id="thh3" style="width: 50px">Price</th>
                                                <th id="thh4" class="text-center" style="width: 80px">Unit</th>
                                                <th id="thh5" class="text-center" style="width: 59px">Dis%</th>
                                                <th id="thh6" class="text-center" style="width: 51px">Dis$</th>
                                                <th id="thh7" style="width: 56px;padding-right: 10px;text-align: right;">Amount</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
                ...
                <div class="col-lg-8 col-xs-10" style="text-align:right; font-size: 10px;padding-top: 20px;">
                    <input type="hidden" name="dis_inv_dollar" id="dis_inv_dollar" />
                    <!--Tab Total-->
                    <div class="row item_grand">
                        <div class=" col12" style="text-align:left;"><?php echo "TOTAL" ?></div>

                        <div class="col3"><b>:USD</b></div>
                        <div class="col4" id="p_total" style="font-weight: bold;padding-right:0px;"> 0.00</div>
                    </div>

                    <div class="row item_grand">
                        <div class=" col12" style="text-align:left;"><?php echo "DISCOUNT" ?></div>

                        <div class="col3"><b>:USD</b></div>
                        <div class="col4" id="p_dis" style="font-weight: bold;padding-right:0px;"> 0.00</div>
                    </div>

                    <div class="row item_grand">
                        <div class="col1" style="text-align:left;"><?php echo "DIS. %" ?></div>
                        <div class="col2" id="lbl_dis_all"></div>
                        <div class="col3"><b>:USD</b></div>
                        <div class="col4" id="p_dis_all" style="font-weight: bold;padding-right:0px;"> 0.00</div>
                    </div>

                    <div class="row item_grand">
                        <div class="col1" style="text-align:left;"><?php echo "VAT %" ?></div>
                        <div class="col2" id="lbl_tax"></div>
                        <div class="col3"><b>:USD</b></div>
                        <div class="col4" id="p_tax" style="font-weight: bold;padding-right:0px;"> 0.00</div>
                    </div>

                    <div class="row item_grand" style="color: red;">
                        <div class="col12" style="text-align:left; font-size:18px"><?php echo "GRAND TOTAL" ?></div>

                        <div class="col3" style="font-size:18px;"><b>:USD</b></div>
                        <div class="col4" id="p_grand_total" style="font-weight: bold;padding-right:0px;font-size:18px;"> 0.00</div>
                    </div>
            </div>
                    
                <div class="clearfix"></div>
                <div class="row" style="position: fixed;bottom: 0px; width: 100%;z-index: 0;" >
                    <div class="col-sm-12 col-md-12 col-lg-12" id="panel_caculater">
                        <div class="col-sm-12 col-md-12 ">
                            <div class="row">
                                <div class="btn-col col-xs-2">
                                ...
                                <div class="btn-col col-xs-2">
                                    <button class="btn btn-lg btn-block btn-smile button" onclick="confirm_dis()">DisInv</button>
                                </div>
                                <div class="btn-col col-xs-2">
                                    <button class="btn btn-lg btn-block btn-smile button inverse" onclick="openModal('frm_merge_table')">Merge</button>
                                </div>
                                <div class="btn-col col-xs-2">
                                    <button class="btn btn-lg btn-block btn-smile button pi" onclick="confirm_split()" >Split</button>
                                </div>
                                <div class="btn-col col-xs-2">
                                    <button class="btn btn-lg btn-block btn-smile button">Del</button>
                                </div>
                                <div class="btn-col col-xs-2">
                                    <button class="btn btn-lg btn-block btn-smile button" id="btn-order">Order</button>
                                </div>
                                <div class="btn-col col-xs-2">
            ...
            <div class="col-lg-7 col-md-6 col-sm-6" style="padding: 0px;">
                <div clsss="row" id="panel_path" >
                    <div class="col-lg-12 col-md-12 col-sm-12" style="/*height: 35px; margin-top: -2px;*/">
                        <button type="button" name="btn_" id="btn_home" onclick="go_back()"><i class="fa fa-fw fa-lg fa-arrow-left" style="color: #fff;"></i><i class="fa fa-fw fa-lg fa-angle-right" id="angle_right" style="color: #fff;"></i>
                        </button>
                        <label id="lbl_category" style="margin-bottom: 0;color: #fff;font-weight: bolder;"></label>
                        <input type="text" name="scan_barcode" id="scan_barcode" class="pull-right form-control" style="width: 250px;border-radius: 4px;margin-right: -11px;" placeholder="Scan Barcode...">
                ...
                <div id="panel_layout">
                    <div class="tab_cate" id="cate_layout" style="">
        ...
        <style type="text/css">
            ...
            .btn_qty_group_active{
                background: red;
            }
        </style>
        <!-- Modal SELECT QTY-->
        <div id="frm_select_qty" class="modal_form">
            <div class="modal-content" style="width:700px;top:-41px;">
                <div class="modal-header" style="background-color: #13224B;">
                    <h3 class="modal-title" style="text-align: center;color: white;font-family:Khmer OS Battambang;" id="txt_item_select_qty">ប្រហុកគ្រឿងអាំង</h3>
                </div>
                <div class="modal-body">
                    <div class="panel panel-default col-lg-12 col-md-12 col-sm-12">
                        <div class="panel-body">
                            <div class="col-md-12 col-sm-12" style="">
                                <div class="calc-row btn_group_qty_select" style="height:auto;background:#0000004a;padding-top:5px;padding-bottom:5px;">
                                    <input type="button" class="button-sear btn_qty_group_active" data-base="0" value ="1-9">
                                    <input type="button" class="button-sear" data-base="10" value ="10-19">
                                    <input type="button" class="button-sear" data-base="20" value ="20-29">
                                    <input type="button" class="button-sear" data-base="30" value ="30-39">
                                    <input type="button" class="button-sear" data-base="40" value ="40-49">
                                    <input type="button" class="button-sear" data-base="50" value ="50-59">
                                    <input type="button" class="button-sear" data-base="60" value ="60-69">
                                    <input type="button" class="button-sear" data-base="70" value ="70-79">
                                    <input type="button" class="button-sear" data-base="80" value ="80-89">
                                    <input type="button" class="button-sear" data-base="90" value ="90-99">
                                </div>
                                <div class="calc-row btn_qty_select" style="height:auto;border: 1px solid #0000004a;padding-top:20px;padding-bottom:20px;">
                                    <input type="button" class="button-sear btn_qty" value ="1" onclick="select_qty(this);">
                                    <input type="button" class="button-sear btn_qty" value ="2" onclick="select_qty(this);">
                                    <input type="button" class="button-sear btn_qty" value ="3" onclick="select_qty(this);">
                                    <input type="button" class="button-sear btn_qty" value ="4" onclick="select_qty(this);">
                                    <input type="button" class="button-sear btn_qty"value ="5" onclick="select_qty(this);">
                                    <input type="button" class="button-sear btn_qty" value ="6" onclick="select_qty(this);">
                                    <input type="button" class="button-sear btn_qty" value ="7" onclick="select_qty(this);">
                                    <input type="button" class="button-sear btn_qty" value ="8" onclick="select_qty(this);">
                                    <input type="button" class="button-sear btn_qty" value ="9" onclick="select_qty(this);">
                                    <input type="button" class="button-sear btn_qty"  value ="10" onclick="select_qty(this);">
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <br>
                                    <div class="col-md-12 col-sm-12">
                                        <button class="button-sear col-md-6 col-sm-6 pull-right" onclick="closeModal('frm_select_qty')">CLOSE</button>
                                    </div >
                                </div>
                            </div>
                        </div>
        ...
        <!--End Modal SELECT QTY-->
        <!--End Modal Discount Percent-->
        <div id="frm_discount_invoice" class="modal_form">
            <div class="modal-content" style="width:fit-content;top:-41px;">
                <div class="modal-header" style="background-color: #13224B;">
                    <h3 class="modal-title" style="text-align: center;color: white;">DISCOUNT PERCENT</h3>
                </div>
                <div class="modal-body" >
                    <div class="panel panel-default col-lg-12 col-md-12 col-sm-12">
                        <div class="panel-body">
        ...
        <!--Start Modal Discount Invoice Dollar-->

        <div id="frm_discount_invoice_dollar" class="modal_form">
            <div class="modal-content" style="width:fit-content;top:-41px;">
                <div class="modal-header" style="background-color: #13224B;">
                    <h3 class="modal-title" style="text-align: center;color: white;">DISCOUNT DOLLAR</h3>
                </div>
                <div class="modal-body" >
                    <div class="panel panel-default col-lg-12 col-md-12 col-sm-12"> 
                        <div class="panel-body">
                            <div class="calculator calculator-sear  col-md-6 col-sm-6">
                                <div id="alert_dis_inv_dollar" class="hidden">
                                    <p style="width: 100%;color: red;">Invalid Discount!!!</p>
                                </div>
                                <div style="height:58px;">
                                    <input type="text" id="txt_my_discount_invoice_dollar" autofocus class="form-control" style="width: 100%;">
                                </div>
                                <div class="calc-row" style="height:58px;">
                                    <input type="button" class="button-sear-cal trigger-sear" style="margin: 8px;" value ="7" onclick="get_discount('#txt_my_discount_invoice_dollar',this.value)"><input type="button" class="button-sear-cal trigger-sear" style="margin: 8px;" value ="8" onclick="get_discount('#txt_my_discount_invoice_dollar',this.value)"><input type="button" class="button-sear-cal trigger-sear" style="margin: 8px;" value ="9" onclick="get_discount('#txt_my_discount_invoice_dollar',this.value)">
                                </div>
                                <div class="calc-row" style="height:58px;">
                                    <input type="button" class="button-sear-cal trigger-sear" style="margin: 8px;" value ="4" onclick="get_discount('#txt_my_discount_invoice_dollar',this.value)"><input type="button" class="button-sear-cal trigger-sear" style="margin: 8px;" value ="5" onclick="get_discount('#txt_my_discount_invoice_dollar',this.value)"><input type="button" class="button-sear-cal trigger-sear" style="margin: 8px;" value ="6" onclick="get_discount('#txt_my_discount_invoice_dollar',this.value)">
                                </div>
                                <div class="calc-row" style="height:58px;">
                                    <input type="button" class="button-sear-cal trigger-sear" style="margin: 8px;" value ="1" onclick="get_discount('#txt_my_discount_invoice_dollar',this.value)"><input type="button" class="button-sear-cal trigger-sear" style="margin: 8px;" value ="2" onclick="get_discount('#txt_my_discount_invoice_dollar',this.value)"><input type="button" class="button-sear-cal trigger-sear" style="margin: 8px;" value ="3" onclick="get_discount('#txt_my_discount_invoice_dollar',this.value)">
                                </div>
                                <div class="calc-row" style="height:58px;">
                                    <input type="button" class="button-sear-cal trigger-sear" style="margin: 8px;" value ="0" onclick="get_discount('#txt_my_discount_invoice_dollar',this.value)"><input type="button" class="button-sear-cal trigger-sear" style="margin: 8px;" value ="." onclick="get_discount('#txt_my_discount_invoice_dollar',this.value)"><input type="button" class="button-sear-cal trigger-sear" style="margin: 8px;" value ="C" onclick="get_discount('#txt_my_discount_invoice_dollar',this.value)">
                                </div>
                                <div class="calculator calculator-sear  col-md-6 col-sm-6">
                                    <div class="col-md-6 col-sm-6">
                                        <button onclick="save_discount('invoice_dollar','#txt_my_discount_invoice_dollar')" class="button-sear col-md-6 col-sm-6" id="btn_discount">Discount$</button>
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <button class="button-sear col-md-6 col-sm-6" onclick="closeModal('frm_discount_invoice_dollar')">CLOSE</button>
                                    </div >
                                </div>
                            </div>
                        </div>    
            ...
            <div class="modal fade centered-modal" id="frm_payment" role="dialog">
                <div class="modal-dialog">
                  ...
                  <div class="modal-content" style="width:150%;right:145px">
                        ...
                        <div class="modal-body" >
                            <div class="panel col-lg-8 col-md-8 col-sm-8">
                                <table style="border-collapse: separate" class="table-form" width="100%" align="center">
                                 ...
                                 <tr id="credit_payment">
                                        <td></td>
                                        <td>
                                            <input style="width: 35px;height: 35px;vertical-align: middle;margin:0;padding: 0;" id="txt_pay_credit" name="txt_pay_credit" type="checkbox" placeholder="text box-shadow" autocomplete="off">&nbsp;
                                            <span class="label-sear" style="font-size:20px;color: #13224B;">Credit Payment</span>
                                        </td>
                                        <td>
                                            <input style="color:red;font-weight: bolder" class="input-sear color-blue" id="txt_credit_payment" name="txt_credit_payment" type="text" readonly placeholder="Credit Payment" autocomplete="off">
                                        </td>                                          
                                    </tr>
                                <tr>
                            ...
                            <div class="panel panel-default col-lg-4 col-md-4 col-sm-4">
                                ...
                                <div class="panel-body">
                                    <div class="calculator calculator-sear  col-md-4 col-sm-4">
                                        <div class="calc-row" >
                                            <input type="button" class="button-sear-cal trigger-sear btn-keypaid" style="width:180px !important;" value ="C" data-key="8">
                                        </div>
                                        <div class="calc-row" style="height:58px;">
                      ...
                      <div class="modal-footer">
                          <div>
                              <button type="submit" class="button-sear" id="btn_pay" name="btn_pay">PAY</button>
                              <button id="cancel_pay" type="button" class="button-sear" data-dismiss="modal">CLOSE</button>
                          </div>
                      </div>
                      </form>
    ...
    <script type="text/javascript">
        function plit_order_note(arg) {
            if($("#txt_split_note").val()=="false"){
                $("#txt_split_note").val('true');
                $(arg).addClass("btn-danger");
        }else{
                $("#txt_split_note").val('false');
                $(arg).removeClass("btn-danger");
            }
        }
        if(second_display){
        ...
        $(document).ready(function() {
           ...
           //alert(control_focus.attr('id'));
            ...
            function submitPayment(){
                var return_us = $("#txt_return_dollar").val().replace(/,/g,'').replace('$ ','');
                var return_kh = $("#txt_return_riel").val().replace(/,/g,'');
                return_us = return_us == "" ? 0 : parseFloat(return_us);
                return_kh = return_kh == "" ? 0 : parseInt(return_kh);
                payInDollar=$('#txt_pay_dollar').val();
                if(payInDollar==""){
                    payInDollar=0;
                }
                payInRiel=$('#txt_pay_riel').val();
                if (payInRiel=="") {
                    payInRiel=0;
                }
                $.ajax({
                    type:"POST",
                    url:"http://127.0.0.1:85/set_display",
                    data: {"return_kh":return_kh,"return_us":return_us,"pay_in_dollar":payInDollar,"pay_in_riel":payInRiel},
            ...
            $("#form").submit(function(e) {
                ...
                var credit_payment = $("#txt_credit_payment").val() == "" ? 0 : parseFloat($("#txt_credit_payment").val().replace(/,/g,'').replace('$ ',''));
                //card pay
                ...
                if(input_amount < grand_return_us && member_card < grand_return_us && other_card < grand_return_us && credit_payment < grand_return_us){
                    alert("Invalid Cash!...");
                    return;
                }
                else{
                    $.ajax({
                        url: '<?php echo site_url("cashier_order/update_sale_status"); ?>',
                        type: 'POST',
                        dataType: 'html',
                        async: false,
                        data: {master_id: $("#txt_master_id").val(),customer_id: $("#txt_customer_id").val(),member_card : member_card,member_discount:member_discount,account_type_id: $("#select_card").val(),other_card : other_card,pay_us:pay_us,pay_kh:pay_kh,customer_chip:customer_chip,txt_pay_credit:$("#txt_pay_credit").prop("checked")},
                    })
            ...
            $("#btn-payment-form").click(function(){
                 var floor_id = "<?=$this->uri->segment(4)?>";
            ...
            $('#frm_payment').on('show.bs.modal', function (event) {
                ...
                var post_url="<?php echo site_url("cashier_order/load_payment"); ?>"+"/"+invoice_no;
                $.ajax({
                    type: 'POST',
                    url: post_url,
                    async: false,
                ...
                //load card type
                $.ajax({
                    url: '<?php echo site_url("cashier_order/load_card_type"); ?>',
                    type: 'POST',
                    async: false,
            ...
            $('#select_card').change((event)=> {
                ...
                if($('#select_card').val()!=0){
                    ...
                    ////////// ssssss
                    $("#txt_pay_credit").prop('disabled', true);
                }
                else{
                    newString = "";
                    ...
                    $("#txt_pay_riel").prop('disabled', false);
                    //////// sssssss
                    $("#txt_pay_credit").prop('disabled', false);
                }
            ...
            ////////////////////// credit payment
            $('#txt_pay_credit').change((event)=> {
                var x = $("#txt_amount_dollar").val();
                var newString;

                if($("#txt_pay_credit").prop("checked")==true){
                    newString = x.replace("$ ","");
                    $("#txt_credit_payment").val("$ " + newString);
                    $("#txt_pay_dollar").prop('disabled', true);
                    $("#txt_pay_riel").prop('disabled', true);
                    ////////// ssssss
            ...
            $('.btn-keypaid').click(function(e){
                ...
                if($(this).val()=='C'){
                    ...
                    if(id=='txt_pay_dollar'){
                        ...
                        var value = control_focus.val();
                        var btn_num = $(this).val();
                        control_focus.val(parseInt(value+btn_num));
                        control_focus.focus();
                    }else if(id=='txt_my_discount_category'){
                        var value = control_focus.val();
                        var btn_num = $(this).val();
                        value = parseInt(value+btn_num)<=100? parseInt(value+btn_num) : 100;
                        control_focus.val(parseInt(value));
                        control_focus.focus();
                    }
        ...
        function check_old_new_item_order(){
         var master_id = $("#txt_master_id").val();
         $.ajax({
                url: "<?=site_url('Cashier_order/check_item_order')?>",
                type: 'POST',
                data:{'master_id':master_id},
                dataType: 'json', // covert to json
                success: function(res) {
                    if(res.new_order!=res.old_order || res.old_deleted_order>0){
                      $("#btn-order").css('background-color','red');
                  }else{
                      $("#btn-order").css('background-color','#0690ce');
                  }
                }
            });
        }
           function check_note_item_order(){
         var master_id = $(txt_master_id).val();
         $.ajax({
                url: "<?=site_url('Cashier_order/check_item_note_order')?>",
                type: 'POST',
                data:{'master_id':master_id},
                dataType: 'json', // covert to json
                success: function(res) {
                   $("#txt_old_item_order").val(res.old_order);
                   $("#txt_new_item_order").val(res.new_order);
                    if(res.new_order!=res.old_order || res.old_deleted_order>0){
                     $("#btn-order").css('background-color','red');
                  }else{
                     $("#btn-order").css('background-color','#0690ce');
    ...
    //             });
        ...
        function scan_card(value){
            ...
            customer_chip = value;
            var post_url="<?php echo site_url("cashier_order/get_customer_scan_card"); ?>";
    ...
    <script>
        ...
        function save_discount(type_dis,mytxt){
            ...
            if(type_dis=="percent"){
                if(parseFloat(discount)>100 || parseFloat(discount)<0){
                    ...
                    $('#alert_dis_inv_dollar').removeClass('hidden');
                    ...
                    $('#txt_my_discount_invoice_dollar').addClass('border border-danger');
                    //display();
                    return;
                }
            }
            ...
            else if(type_dis=="invoice_dollar"){
                if(parseFloat(discount)>parseFloat($("#p_total").text()) || parseFloat(discount)<0){
                    $('#alert_dis_dol').removeClass('hidden');
                    $('#alert_dis_per').removeClass('hidden');
                    $('#alert_dis_inv').removeClass('hidden');
                    $('#alert_dis_inv_dollar').removeClass('hidden');
            ...
            $.ajax({
                    type: 'POST',
                    url: '<?php echo site_url('cashier_order/save_discount')?>',
                    ...
                    success: function (response) {
                        if(type_dis=="dollar"){
                            ...
                            closeModal('frm_discount_invoice_dollar')
                        }
                        reload_order();
                        display();
                    },
        ...
        function openModal_dis(modal){
            ...
            if(modal=='frm_discount_percent'){
                ...
                document.getElementById(modal).style.display = "block";
            } else if(modal=='frm_discount_invoice_dollar'){
        ...
        function openModal(modal){
            if(modal=='frm_move_table'){
                ...
                }else if(modal=='modal-customer-count'){
                document.getElementById(modal).style.display = "block";
                $("#cust").focus();
                $("#cust").select();
                ...
                if(check_no_order()==1){
                    ...
                    $.ajax({
                        type:"POST",
                        url:'<?php echo site_url('cashier_order/get_printed_bill')?>',
                        async:false,
                        data:{'master_id':master_id},
                    ...
                    if(temp==false){
                        ...
                        setTimeout(function(){
                            void_invoice($("#txt_master_id").val());
                        },200);
                    }
        ...
        function check_permission(permission_name){
            var result=0;
             $.ajax({
                    type: 'POST',
                    url: '<?php echo site_url('cashier_order/check_permission')?>',
                    async: false,
        ...
        function closeModal(modal){
            ...
            $('#txt_my_discount_invoice_dollar').removeClass('border border-danger');
        ...
        function display(){
            ...
            if(second_display){
                socket.emit('order',{
                    ...
                    post_url:'<?php site_url();?>/cashier_order/order_list'
                });
            }
        ...
        function minus_qty(detail_id,item_detail_id){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('cashier_order/get_printed')?>',
                async: false,
                data:{'id':detail_id},
                success: function (response){
                    if(qty==response){
        ...
        function qty_change(detail_id,item_id,cut_stock){
            var qty=parseInt($('#txt_qty'+detail_id+'').val());
            ...
            $.ajax({
                    type: 'POST',
                    url: '<?php echo site_url('cashier_order/get_de_qty')?>',
                    async: false,
                    data:{'id':detail_id},
                    success: function (response){
                        old_qty=response;
        ...
        function update_qty(detail_id,qty){
            ...
            $.ajax({
                    type: 'POST',
                    url: '<?php echo site_url('cashier_order/update_qty')?>',
                    async: false,
        ...
        function confirm_dis(){
            ...
            swal({
                    ...
                    type: "warning",
                    showCancelButton: true,
                    confirmButtonText: "DisInv%",
                    cancelButtonText: "DisInv$",
                    closeOnConfirm: false,
                    closeOnCancel: false
                }, function (isConfirm) {
                    if (isConfirm){
                        openModal_dis('frm_discount_invoice');
                        
                    } else { 
                        openModal_dis('frm_discount_invoice_dollar');  
                    }
                });
        }
        ...
        function split_table(layout,master_id){
            swal({
                ...
                closeOnCancel: true
                    ...
                    var post_url = '<?php  echo site_url('cashier_order/save_split_table') ?>';
                    //var ch=JSON.stringify(ch_item);
                    if (isConfirm){
        ...
        function sale_return(master_id){
            swal({
                ...
                closeOnCancel: true
                    ...
                    var post_url = '<?php  echo site_url('cashier_order/save_sale_return') ?>';
                    //var ch=JSON.stringify(ch_item);
                    if (isConfirm){
        ...
        function split_invoice(master_id){
            swal({
                ...
                closeOnCancel: true
                    ...
                    var post_url = '<?php  echo site_url('cashier_order/save_split_invoice') ?>';
                    //var ch=JSON.stringify(ch_item);
                    if (isConfirm){
...
//                        alert(e.table_name);
        ...
        function move(table_id,master_id){
             message_box(table_id, master_id,0, 'Are you sure?','You want to move table!','<?php echo site_url("move_table/save"); ?>','<?php echo site_url("cashier_order/new_order"); ?>');
        }
        ...
        function load_main_cate(){
            document.getElementById("table_name").setAttribute("style","float: right");
            var post_url = '<?php echo site_url('cashier_order/load_main_category'); ?>';
            var html = '';
            var count_item=0;
            var width=0;
            var default_id ='';
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.trim() !== '[]' || response.trim() !== '') {
                        ...
                        for (var i = 0; i < list.length; i++) {
                            if(i==0){
                                default_id=list[i].category_id;
                                default_name=list[i].category_name;
                            }
                            count_item+=1;
                            if (list[i].item_type_photo == "" || list[i].item_type_photo == null) {
                                html += '<div class="category_list" id="'+ list[i].category_id +'" onClick="load_item_type('+list[i].category_id+',\'' + list[i].category_name+'\')">'
                                        + '<img src="<?php echo base_url("img/icons/img_not_found.jpg"); ?>"  class="img-circle"  alt=""/>'
                                        + '<div class="desc" data-id="'+list[i].category_id+'" data-name="'+list[i].category_name+'" id="'+ list[i].category_id+'desc'+'">' + list[i].category_name + '</div>'
                                        + '</div>';
                            } else {
                                html += '<div class="category_list" id="'+ list[i].category_id +'" onClick="load_item_type('+list[i].category_id+')">'
                                        + '<img src="<?php echo base_url("img/item_type/"); ?>/' + list[i].item_type_photo + '" class="img-circle img-responsive" alt=""/>'
                                        + '<div class="desc" id="'+ list[i].category_id+'desc'+'"  >'  + list[i].category_name + '</div>'
                                        + '</div>';
                            }
                        }
                        ...
                        for(var i=0; i<(count_item); i++)
                            ...
                            load_item_type(default_id,default_name);
        ...
        function load_category(){
            document.getElementById("table_name").setAttribute("style","float: right");
            if(use_main_category==true){
                var post_url = '<?php echo site_url('cashier_order/load_category'); ?>';
            }else{
                var post_url = '<?php echo site_url('cashier_order/load_category_no_main'); ?>';
            }
            var html = '';
            var count_item=0;
            var width=0;
        ...
        function imgError(image) {
            image.onerror = "";
            image.src = "/rms/rms_basic/img/company/no_images.jpg";
            return true;
        }
        function load_item_type(id,name){
            //Add style border to div category
            $(".category_list").removeClass("border_category");
            $(".desc").removeClass("background_desc");
            $("#" + id).addClass("border_category");
            $("#" + id+"desc").addClass("background_desc");
            //end style
            //if(load=='false')
                //animation_item();
            count=0;
            var post_url = '<?php echo site_url('cashier_order/load_category'); ?>' + '/' + id;
            var html = '';
            $.ajax({
                type: 'POST',
                url: post_url,
                ...
                success: function (response) {
                    ...
                    if (response.trim() !== '[]' || response.trim() !== '') {
                        ...
                        for (var i = 0; i < list.length; i++) {
                            if (list[i].item_type_photo == "" || list[i].item_type_photo == null) {
                                 img="<?php echo base_url("img/company/no_images.jpg"); ?>";
                            }else{
                                img="<?php  echo base_url("img/item_type/"); ?>"+'/'+list[i].item_type_photo;
                            }
                            html += '<div  class="item_detail_list shadow" id="'+list[i].item_type_id+'" onClick="load_itemdetail(\'' + list[i].item_type_id+'\','+'\'' + list[i].item_type_name+'\','+ 'false' +','+id+','+'\'' + name+'\')" >'
                                         +'<div class="item_detail_list_img">'
                                         +'<img src="'+img+'" onError="imgError(this);">'

                                         +'</div>'
                                         +'<div style="background-color:#f70d0d" class="item_detail_list_name">'
                                         + list[i].item_type_name
                                         +'</div></div>';
                        }
        ...
        function load_itemdetail(type_id, type_name,load,cat_id,cat_name){
            //Add style border to div category
            $(".category_list").removeClass("border_category");
            $(".desc").removeClass("background_desc");
            if(use_main_category==true){
                $("#" + cat_id).addClass("border_category");
            }else{
            ...
            if(load=='false')
                animation_item();
            count=0;
            var post_url = '<?php echo site_url('cashier_order/load_item_detail'); ?>' + '/' + type_id;
            var html = '';
            $.ajax({
                type: 'POST',
                url: post_url,
                ...
                success: function (response) {
                    ...
                    if (response.trim() !== '[]' || response.trim() !== '') {
                        ...
                        for (var i = 0; i < list.length; i++) {
                            ...
                            html += '<div class="item_detail_list shadow" id="'+list[i].item_detail_id+'" onClick="order(\'' + list[i].item_detail_id+'\','+'\'' + list[i].item_detail_name+'\''+','+'\'' + list[i].price+'\''+','+'\'' + list[i].item_detail_cut_stock+'\''+')">'
                                         +'<div class="item_detail_list_img">'
                                         +'<img src="'+img+'" onError="imgError(this);">'
        ...
        function scan_barcode(datas=null){
            ...
            $(".desc").removeClass("background_desc");
            $('#cate_layout').html('');
            var post_url = '<?php echo site_url('cashier_order/scan_barcode'); ?>';
            var html = '';
            $.ajax({
                type: 'POST',
                url: post_url,
        ...
        function check_stock(item_detail_id,qty){
            ...
            var post_url="<?php echo site_url("cashier_order/check_stock"); ?>";
            var a=0;
            $.ajax({
                type: 'POST',
                url: post_url,
        ...
        function reload_display(){
            ...
            $.ajax({
                type: "POST",
                url: "http://127.0.0.1:85/set_display",
                data:{"layout_id":table_id,"master_id":sale_master_id,"return_kh":0,"return_us":0,"pay_in_dollar":0,"pay_in_riel":0},
                success: function(res){
        ...
        function order(item_detail_id,item_detail_name,item_detail_price,cut_stock){
            var ordered = $("#order_item"+item_detail_id);
            if(ordered.length>0 && $("#txt_split_note").val()=="false"){
                plu_qty(ordered.attr("sale-detail-id"),item_detail_id,ordered.attr("cut-stock-status"));
                return;
            }
            if($("#txt_split_note").val()=="true"){
                $("#btn_split_note").click();
            } 
            ...
            if($('#txt_master_id').val()==""){
                openModal('modal-customer-count');
            }
            //return false;
            var post_url="<?php echo site_url("cashier_order/save");?>";
            $.ajax({
                type: 'POST',
                url: post_url,
                async: false,
      ...
      //                   });
         ...
         function reload_order(){
            ...
            success: function (response) {  
                ...
                $.each(value.sale,function(i,e){
                    ...
                    $('#dis_inv_dollar').val(e.dis_dollar_all);
                   
                    $('#lbl_tax').text(e.tax);
                    $('#txt_master_id').val(e.sale_master_id);
                    $('#txt_exchange_rate').val(e.sale_master_ex_rate);
                    $('#btn_edit_pax').show();
                    $('#cust').val(e.sale_master_pax);
                    $.each(e.sale_detail,function(k,j){

                            var item_detail_price=numeral(j.price).format('#.'+dot_0+'');
                            var ch_box='<td style="text-align:left;padding-left:10px;width: 40px;"> <input type="checkbox" class="check-box-main" value="'+j.sale_detail_id+'" id="ch_item_detail" name="ch_item_detail[]" style="padding:1px;"></td>';

                            var item_name='<td class="item">'+j.detail_name+'</td>';
                            var item_price='<td class="item_nest" style="text-align:left;">'+item_detail_price+'</td>';
                            var qtys='<div class="input-group"><span class="input-group-btn"><button type="button" onclick="minus_qty('+j.sale_detail_id+','+j.item_id+')" class="btn btn-danger btn-number btn-xscc" data-type="minus" data-field="quant[2]"><span class="glyphicon glyphicon-minus"></span></button></span><input type="text" style="padding:0;" id="txt_qty'+j.sale_detail_id+'" onChange="qty_change('+j.sale_detail_id+','+j.item_id+','+j.cut_stock+')" name="quant[2]" class="form-control input-number text-center my-blur input-xscc" readonly style="font-size: 17px;color: #13224B;" value="'+j.qty+'" min="1"><span class="input-group-btn"><button sale-detail-id="'+j.sale_detail_id+'" cut-stock-status="'+j.cut_stock+'"  id="order_item'+j.item_id+'" type="button" onclick="plu_qty('+j.sale_detail_id+','+j.item_id+','+j.cut_stock+')" class="btn btn-success btn-number btn-xscc" data-type="plus" data-field="quant[2]"  ><span class="glyphicon glyphicon-plus"></span></button></span></div>';
                            ...
                            var amount='<td class="item_nest" style="text-align:right;padding-right:10px;">'+numeral(item_detail_price*j.qty).format('#.'+dot_0+'')+'</td>';
                            ...
                            $.each(j.sale_note,function(f,g){
                                    var item_note_price=numeral(g.price).format('#.'+dot_0+'');
                                        ...
                                        var item_note_prices='<td class="item_nest" style="text-align:left !important;">'+item_note_price+'</td>';
                            ...
                            var sub_total='<tr class="sub_total sub_total'+j.sale_detail_id+' hidden"><td style="height: 20px;"></td> <td class="item"></td><td class="item_nest"></td> <td class="item_nest"></td><td class="item_nest">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sub</td>  <td class="item_nest"> Total</td> <td class="item_nest">'+numeral(grand_sub_total).format('#.'+dot_0+'')+'</td></tr> ';
        ...
        function add_to_list(sale_detail_id,item_detail_id,item_detail_name,item_detail_price,cut_stock){
                ...
                var qtys='<div class="input-group" ><span class="input-group-btn"><button type="button" onclick="minus_qty('+sale_detail_id+','+item_detail_id+')" class="btn btn-danger btn-number btn-xscc" data-type="minus" data-field="quant[2]"><span class="glyphicon glyphicon-minus"></span></button></span><input type="text" id="txt_qty'+sale_detail_id+'" onChange="qty_change('+sale_detail_id+','+item_detail_id+','+cut_stock+')" name="quant[2]" class="form-control input-number text-center my-blur input-xscc" readonly value="1" min="1"><span class="input-group-btn"><button type="button" onclick="plu_qty('+sale_detail_id+','+item_detail_id+','+cut_stock+')" class="btn btn-success btn-number btn-xscc" data-type="plus" data-field="quant[2]"><span class="glyphicon glyphicon-plus"></span></button></span></div>';
                var qty='<td class="item_nest">'+qtys+'</td>';
                ...
                var sub_total='<tr class="sub_total sub_total'+sale_detail_id+' hidden"><td style="height: 20px;"></td> <td class="item"></td> <td class="item_nest"></td> <td class="item_nest"></td> <td class="item_nest">Sub</td> <td class="item_nest">Total</td> <td class="item_nest">'+item_detail_price+'</td></tr> ';
        ...
        function totals(){
                   ...
                   /* var tax=parseFloat(numeral(total).format('#.'+dot_0+''))*parseFloat(numeral(tax_per/100).format('#.'+dot_0+''));*/
              ...
              table.find('tr.item_detail').each(function (i, el) {
                            var $tds = $(this).find('td');
                                ...
                                if(dis_percent>0){
                                    ...
                                    grand_total_dis+= dis_dollar*qty;
                                }    
                        });

                grand_total_dis=parseFloat($('#dis_inv_dollar').val()) + grand_total_dis; 
        ...
        function delete_item_detail(){
            ...
            if(ch_item.length<=0 && ch_item1.length<=0){
            ...
            setTimeout(function(){
                swal({
                    ...
                    if (isConfirm){
                        ...
                        $.ajax({
                            url: "<?php echo site_url('cashier_order/delete_item_detail'); ?>",
                            type: 'POST',
                            async: false,
                            dataType: 'html',
        ...
        function save_item_note(item_note_id,item_note_name,item_note_price){
            var table = $("#table_order tbody");
             ...
             if($('.note'+item_note_id+'_'+s_detail_id+' ').length>0){
              ...
              var post_url = "<?php echo site_url('cashier_order/save_item_note'); ?>";
                $.ajax({
                    type: 'POST',
                    url: post_url,
                    async: false,
        ...
        function load_item_note() {
            count=0;
            var post_url = '<?php echo site_url('cashier_order/load_item_note'); ?>';
            var html = '';
            $.ajax({
                type: 'POST',
                url: post_url,
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.each(json.sale,function(i,e){
                            ...
                            keep_order += '<table style="width: 265px;" id="table_lists" cellpadding="0" cellspacing="0" class="receipt-size">';
                            ...
                            if(temp=="bill"){
                                ...
                                keep_order += '<td colspan="5" class="headright">Out : '+
                                new Date(e.sale_master_end_date).toLocaleTimeString()+'</td></tr>';
                            }

                            data+='<tr><td colspan="1" class="headleft">Cashier : '+ e.cashier +'</td>';
                            keep_order+='<tr><td colspan="1" class="headleft">Cashier : '+ e.cashier +'</td>';
                            data+='<td colspan="5" class="headright">Table: '+$('#table_name').html()+'</td></tr>';
                            keep_order+='<td colspan="5" class="headright">Table: '+$('#table_name').html()+'</td></tr>';

                           
                            if(temp=="bill"){
                                 data+='<tr><td colspan="6" class="headcenter">BILL</td></tr>';
                            }else if(temp=="receipt"){
                                data+='<tr><td colspan="1">Ticket number:</td><td colspan="6" class="headcenter" style="font-size:40px;font-weight:bold;text-align:left">'+e.sale_order_number+'</td></tr>';
                                keep_order+='<tr><td colspan="1">Ticket number:</td><td colspan="6" class="headcenter" style="font-size:40px;font-weight:bold;text-align:left;">'+e.sale_order_number+'</td></tr>';
                            ...
                            keep_order += '<tr><td colspan="1" class="table_headleft">Item</td>';
                            data+=  '<td colspan="1" class="table_headcenter">Qty</td>';
                            keep_order+=  '<td colspan="1" class="table_headcenter">Qty</td>';
                            data += '<td colspan="1" class="table_headcenter">Price</td>';
                            keep_order += '<td colspan="1" class="table_headcenter">Price</td>';

                            if(dis_dollar != 0 ){
                            data += '<td colspan="1" class="table_headcenter">Dis$</td>';
                            keep_order += '<td colspan="1" class="table_headcenter">Dis$</td>';
                            }else{
                                 data += '<td colspan="1" class="table_headcenter">Dis$</td>';
                                keep_order += '<td colspan="1" class="table_headcenter">Dis$</td>';
                            }
                            ...
                            data+=  '<td colspan="1" class="table_headcenter" style="text-align:right;">Amount</td></tr>';
                            keep_order+=  '<td colspan="1" class="table_headcenter" style="text-align:right;">Amount</td></tr>';

                            $.each(e.sale_detail,function(j,t){
                                 var notes='';
                                    var total=t.sale_note.length;
                                    $.each(t.sale_note,function(l,m){
                                        notes += '<tr><td colspan="1" class="mainleft">*'+m.item_note_name+'</td><td colspan="1" class="maincenter">'+m.qty+'</td><td colspan="1" class="maincenter">'+m.price+'</td><td colspan="1" class="maincenter"></td><td colspan="1" class="maincenter"></td><td colspan="1" class="maincenter" style="text-align:right;">'+m.price+'</td></tr>';
                                    });
                                item += '<tr><td colspan="1" style="font-weight: bold;font-size: '+font_small+';font-family: Khmer OS Battambang;border-bottom: 0.5px dotted black;">'+(j+1)+'. '+t.detail_name+'</td><td colspan="1" class="maincenter"">'+t.qty+'</td><td colspan="1" class="maincenter">'+t.price+'</td>'

                                if(t.dis_dollar != 0){
                                item+= '<td colspan="1" class="maincenter">'+t.dis_dollar+'</td>'
                                }else{
                                    item+= '<td colspan="1" class="maincenter"></td>'
                           
                                }
                                item+= '<td colspan="1" class="maincenter">'+t.dis_percent+'</td>'

                                item+= '<td colspan="1" class="maincenter" style="text-align:right;">'+((t.qty*t.price)-((t.qty*t.dis_dollar)+((t.dis_percent*t.price/100)*t.qty))).toFixed(dot_num)+'</td></tr>'+notes;
                            });

                            data += item;
                            keep_order += item;

                            var p_subtotal=0,p_subtotal_reil=0;                       
                            if(e.dis_inv==0 && e.discount_invoice_dollar==0){
                                p_subtotal=parseFloat($("#p_total").html())-parseFloat($("#p_dis").html());
                            }else{
                                p_subtotal=parseFloat($("#p_total").html());
                            }
                            p_subtotal_reil=parseInt((e.ex_rate*p_subtotal).toFixed(0)).toLocaleString( "en-US" );  

                            data+='<tr><td colspan="2" class="subright_ftborder">Sub Total:</td><td colspan="2" class="subright_ftborder" style="font-size:12px">'+p_subtotal_reil+' ៛</td><td style="font-size:12px" colspan="2" class="subright_ftborder">$ '+p_subtotal.toFixed(2).toLocaleString("en-US" )+'</td></tr>';


                            keep_order+='<tr><td colspan="2" class="subright_ftborder">Sub Total:</td><td colspan="2" class="subright_ftborder" style="font-size:12px">'+p_subtotal_reil+' ៛</td><td style="font-size:12px" colspan="2" class="subright_ftborder">$ '+p_subtotal.toFixed(2).toLocaleString( "en-US" )+'</td></tr>';
                        
                            if(e.dis_inv != 0 ){
                            data+='<tr><td colspan="2" class="subright">Discount '+e.dis_inv+'%:</td><td style="font-size:12px" colspan="2" class="subright">'+parseInt((e.ex_rate*$("#p_dis_all").html()).toFixed(0)).toLocaleString( "en-US" )+' ៛</td><td style="font-size:12px" colspan="2" class="subright">$ '+$("#p_dis_all").html()+'</td></tr>';

                            keep_order+='<tr><td colspan="2" class="subright">Discount '+e.dis_inv+'%:</td><td colspan="2" style="font-size:12px" class="subright">'+parseInt((e.ex_rate*$("#p_dis_all").html()).toFixed(0)).toLocaleString( "en-US" )+' ៛</td><td style="font-size:12px" colspan="2" class="subright">$ '+$("#p_dis_all").html()+'</td></tr>';
                            }
                             if(e.discount_invoice_dollar != 0 ){
                            data+='<tr><td colspan="2" class="subright">Discount:</td><td style="font-size:12px" colspan="2" class="subright">'+parseInt((e.ex_rate*e.discount_invoice_dollar).toFixed(0)).toLocaleString( "en-US" )+' ៛</td><td style="font-size:12px" colspan="2" class="subright">$ '+e.discount_invoice_dollar+'</td></tr>';

                            keep_order+='<tr><td colspan="2" class="subright">Discount:</td><td style="font-size:12px" colspan="2" class="subright">'+parseInt((e.ex_rate*e.discount_invoice_dollar).toFixed(0)).toLocaleString( "en-US" )+' ៛</td><td style="font-size:12px" colspan="2" class="subright">$ '+e.discount_invoice_dollar+'</td></tr>';
                            }
                            ...
                            if(e.member_discount!=0){
                                ...
                                keep_order+='<tr><td colspan="2" class="subright">Member '+e.member_discount+'%:</td><td colspan="2" class="subright">'+parseInt((dis_member)*e.ex_rate).toLocaleString( "en-US" )+' R</td><td colspan="2" class="subright">$ '+dis_member+'</td></tr>';
                            }
                            if(e.vat!=0){
                                var temp_vat=(((p_subtotal-$("#p_dis_all").html()-dis_member-e.discount_invoice_dollar)*e.vat)/100).toFixed(dot_num);
                                
                               data+='<tr><td colspan="2" class="subright">VAT '+e.vat+'%:</td><td style="font-size:12px" colspan="2" class="subright">'+parseInt((temp_vat)*e.ex_rate).toLocaleString( "en-US" )+' ៛</td><td style="font-size:12px" colspan="2" class="subright">$ '+ temp_vat +'</td></tr>';

                               keep_order+='<tr><td colspan="2" class="subright">VAT '+e.vat+'%:</td><td style="font-size:12px" colspan="2" class="subright">'+parseInt((temp_vat)*e.ex_rate).toLocaleString( "en-US" )+' ៛</td><td style="font-size:12px" colspan="2" class="subright">$ '+ temp_vat +'</td></tr>'; 
                            }
                            if(temp=="bill"){
                                data+='<tr><td colspan="2" style="font-size:14px" class="subright_ftborder">Total:</td><td style="font-size:14px" colspan="2" class="subright_ftborder">'+parseInt(e.ex_rate*$("#p_grand_total").html()).toLocaleString( "en-US" )+' ៛</td><td colspan="2" style="font-size:14px" class="subright_ftborder">$ '+$("#p_grand_total").html()+'</td></tr>';
                            }
                            else if(temp=="receipt"){
                                data+='<tr><td colspan="2" style="font-size:14px" class="subright_ftborder">Total:</td><td colspan="2" style="font-size:14px" class="subright_ftborder">'+$('#txt_amount_riel').val()+' </td><td colspan="2" style="font-size:14px" class="subright_ftborder">$ '+grand_return_us+'</td></tr>';
                                keep_order+='<tr><td colspan="2" class="subright_ftborder">Total:</td><td colspan="2" class="subright_ftborder">'+$('#txt_amount_riel').val()+' </td><td colspan="2" class="subright_ftborder">$ '+grand_return_us+'</td></tr>';
                                var cash_type="";
                                if(other_card!=0){
                                ...
                                data+='<tr><td colspan="2" style="font-size:14px" class="subright">'+cash_type+':</td><td colspan="2" style="font-size:14px" class="subright">'+pay_kh+' ៛</td><td colspan="2" style="font-size:14px" class="subright">$ '+my_pay.toFixed(dot_num)+'</td></tr>';

                                keep_order+='<tr><td colspan="2" style="font-size:14px" class="subright">'+cash_type+':</td><td colspan="2" style="font-size:14px" class="subright">'+pay_kh+' ៛</td><td colspan="2" style="font-size:14px" class="subright">$ '+my_pay.toFixed(dot_num)+'</td></tr>';

                                data+='<tr><td colspan="2" style="font-size:14px" class="subright">Return:</td><td style="font-size:14px" colspan="2" class="subright">'+hak_return_kh+' </td><td colspan="2" style="font-size:14px" class="subright">'+hak_return_us+'</td></tr>';

                                keep_order+='<tr><td colspan="2" style="font-size:14px" class="subright">Return:</td><td colspan="2" style="font-size:14px" class="subright">'+hak_return_kh+' </td><td colspan="2" style="font-size:14px" class="subright">'+hak_return_us+'</td></tr>';
                            }
                            ...
                            data+='<tr><td colspan="6" class="footcenter">-</td></tr>';
                            ...
                            myprint(temp,printer,keep_order);
                    });
        ...
        function myprint(temp,printer,keep_order,original,is_devilery){
            setTimeout(function(){
            var html =` <style>
                .comcenter{
        ...
        function select_qty(arg) {
            item_select_qty.val($(arg).val());
            closeModal("frm_select_qty");
            item_select_qty.change();
            $(".btn_group_qty_select input").eq(0).click();
        }
        ...
        $(document).ready(function () {
            ...
            $(document).on("click",".input-number",function(e){
                openModal("frm_select_qty");
                $("#txt_item_select_qty").html($(this).closest("tr").find("td").eq(1).html()+" ចំនួន "+$(this).val());
                item_select_qty=$(this);
            });
            $(document).on("click",".btn_group_qty_select input",function(e){
                var active_group = $(this);
                $(".btn_group_qty_select input").each(function( index ){
                  $(this).removeClass("btn_qty_group_active");
                });
                active_group.addClass("btn_qty_group_active");
                
                $(".btn_qty_select input").each(function( index ){
                    if(active_group.attr("data-base")=="0"){
                        $(this).val(index+1);
                    }else{
                        $(this).val(parseInt(active_group.attr("data-base"))+index);
                    }
                });                
            });
            ...
            discount_keyboard('#txt_my_discount_invoice_dollar');
        ...
        function print_to_kitchen(){
            ...
            //self.close()
            window.open("<?php echo site_url("cashier_order/kitchen_print"); ?>"+"/"+order_no,"_blank");
        ...
        function load_table_name(){
            var post_url = '<?php echo site_url('cashier_order/load_table_name/'); ?>' + '/' + <?php echo $table_id; ?>;
            $.ajax({
                type: 'POST',
                url: post_url,
                async: false,
        ...
        function load_tax(){
            var post_url="<?php echo site_url("cashier_order/load_tax"); ?>";
            $.ajax({
                type: 'POST',
                url: post_url,
                async: false,
        ...
        function go_back(){
            var id=$('.border_category >div').attr('data-id');
            var name=$('.border_category >div').attr('data-name');
            load_item_type(id,name);
        }
        ...
        $('#scan_barcode').autocomplete({
                ...
                source: function (request, response) {
                    $.ajax({
                        url: '<?php echo site_url("cashier_order/searchproduct"); ?>',
                        dataType: "json",
                        async: false,
                        data: {
    ...
    function void_invoice(master_id){
            ...
            setTimeout(function(){swal({
                    ...
                    if (isConfirm){
                        var post_url="<?php echo site_url("cashier_order/save_void"); ?>";
                        $.ajax({
                            type: 'POST',
                            url: post_url,
                            async: false,
...
//            total_exchange(isNaN(this.value) ? 0 : this.value);
        ...
        function update_card_amount(){
            var post_url = '<?php echo site_url("cashier_order/update_card")?>';
            ...
            $.ajax({
                ...
                success: function (data){
                    ...
                    if(json.statusCode != 'S0001'){
                        window.open("<?php echo site_url("cashier_order/payment_receipt");?>"+ "/" + invoice_no,"_self");
                    }else{
                        alert("An error occure while saving data!");
                    }
        ...
        function resize_table_height(){
                var new_height=$( window ).height();
                var height = new_height - 655;
                $('#panel_order_item').css("height",height+250);
                $('#cate_layout').css("height",height+330);
                $('#panel_layout').css("height",height+330);
            ...
            $("#form-customer-count").on('submit',function(e){
            e.preventDefault();
            var master_id = $('#txt_master_id').val();
            var pax_number = $('#cust').val();
            var post_url = '<?php echo site_url("cashier_order/save_pax");?>';

            $.ajax({
                type: 'POST',
                url: post_url,
                async: false,
                data: {'master_id':master_id,'pax_number':pax_number},
                success: function (response) {
                    closeModal('modal-customer-count');
                },
                error: function (response) {
                }
            });
