...
<html>
    ...
    <script type="text/javascript">
        window.print();
            setTimeout(function () {
                var master_id = '<?php echo $invoice_no?>';
                var post_url = '<?php echo site_url("cashier_order/update_sale_status")?>';
                $.ajax({
                    type: 'POST',
                    url: post_url,
                    async: true,
                    ...
                    success: function (data){
                        ...
                        if(json.statusCode !='S0001'){
                            //window.open("<?php //echo site_url("table_order")?>");
                            window.location = "<?php echo site_url("table_order")?>","_self";
                            
                        }else{
                            alert("An error occure while Printing !");
                        }
        ...
        JsBarcode("#barcode", "<?php echo $info->invoice_no?>", {
            font:"OCR-B",
            height: 60,
            displayValue: false
        });  
