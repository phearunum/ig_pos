            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.each(json.Printer,function(i,e){
                            ...
                            data += '<table id="' + index_table +  '" cellpadding="0" cellspacing="0" class="receipt-size"><tr><td style="width:150px;font-weight: bold;font-size: 14px;font-family: Khmer OS Battambang;">Order : <?php echo $order_by?></td><td colspan="2" style="text-align:right;width:130px;font-weight: bold;font-size: 14px;font-family: Khmer OS Battambang;">Table : <?php echo $table_name?></td></tr>';      
                            data += '<tr><td style="width:150px;font-weight: bold;font-size: 14px;font-family: Khmer OS Battambang;">Date : <?php echo $order_date?></td><td colspan="2" style="text-align:right;width:130px;font-weight: bold;font-size: 14px;font-family: Khmer OS Battambang;"><?php echo $order_time?></td></tr>';
                            data += '<tr><td  style="border-top: black solid 1px;border-bottom: black solid 1px;width:150px;font-weight: bold;font-size: 14px;font-family: Khmer OS Battambang;">Description</td><td style="text-align:center;border-top: black solid 1px;border-bottom: black solid 1px;width:65px;font-weight: bold;font-size: 14px;font-family: Khmer OS Battambang;">Qty</td>';
                            data += '<td style="text-align:center;border-top: black solid 1px;border-bottom: black solid 1px;width:65px;font-weight: bold;font-size: 14px;font-family: Khmer OS Battambang;">Note</td></tr>';
                            ...
                            img.onload = function() {
                                ...
                                if(e.is_print>0){
                                    // appendFileAndSubmit(canvas.toDataURL(),e.printer_name,receipt);
                                    $("body").html($("#div").clone());
                                    $("#div").html($("#1").clone());
                                    window.print();                                  
                                    update_item_printed(receipt);                                  
