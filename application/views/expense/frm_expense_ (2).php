...
<html>
    ...
    <body>
        ...
        <button name="btnSave" type="button" id="btn_add" class="btn btn-vichet"  value="+Add"/><?php echo $btn_add ?></button>
                        ...
                        <table width="100%" class="table-form">
                            ...
                            <tr>
                                <td style="text-align: right" colspan="2">
                                    <button  name="btnSave" type="button" id="btnSave" value="Save" class="btn btn-vichet"/><?php echo $btn_save ?></button>
                                </td>
                            </tr>
                        </table>
                    </td>
