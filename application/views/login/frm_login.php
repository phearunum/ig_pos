       ...
       <div class="element-container">
         ...
         <div class="wrap-login100">
            <form id="frm_login" action="<?php echo site_url('welcome/check_user') ?>"  method="POST">
               ...
               <img src="<?php echo base_url("/assets/images/app_img/Logo.png")?>" style="width:200px;">
               </span>
               <center> <p style="color: white;"> Kattechs Business Solution </p></center>
               <br/>
           
               <div class="wrap-input100 validate-input" data-validate = "Enter username">
                  <input class="input100" type="text" name="txtusername" id="txtusername" 
                  placeholder="Username"  style="border: 1px solid #fff;" >
                  <span class="focus-input100" data-placeholder="&#xf207;"></span>
               </div>
               <div class="wrap-input100 validate-input" data-validate="Enter password">
                  <input class="input100" type="password" name="txtpassword" id="txtpassword" 
                  placeholder="Password" style="border: 1px solid #fff;">
                  <span class="focus-input100" data-placeholder="&#xf191;"></span>
               </div>
               ...
               <div class="container-login100-form-btn">
                <?php
                    ...
                    ?>
                  <input type="submit" class="btn btn-primary" style="font-weight: bold;  color: #fff; width:50% " value="LOGIN"/>
                  <input id="icon-close" type="button" class="btn btn-danger" style="font-weight: bold; color: #fff;width:50%" value="EXIT"/>
                
                   <i onclick="node_osk();" class="fa fa-keyboard-o" style="display: none;" aria-hidden="true"></i>
