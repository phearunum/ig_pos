...
<html>
    ...
    <body>
       <!--  <?php
        ...
        <!-- <?php if($p->permission_add!=0){ ?> --><a class="btn btn-primary pull-right <?php echo $permission_add;?>" href="<?php echo site_url("customer_type/addnew"); ?>"><i class="fa fa-plus"></i> <?php echo $lbl_new?></a><!-- <?php } ?> -->
        ...
        <table width="100%" cellspacing="0" class="table-table" id="table-table" cellpadding="0">
            <thead>
                <tr>
                    ...
                    <th style="text-align: left;"><?php echo $lbl_cus_type?></th>
    ...
    <script type="text/javascript">
            $( document ).ready(function() {
                var table =$('#table-table').DataTable({
                    "bProcessing": false,
                    "sAjaxSource": "<?php echo site_url("Customer_type/response");?>",
                    "aoColumns": [
                        { mData: 'customer_type_id'},
                        { mData: 'customer_type_id',render: function (data, type, row, meta) {
                            return meta.row + meta.settings._iDisplayStart + 1;
                        }},
                        { mData: 'customer_type_name'},
                        { mData: 'customer_type_des'},
                        { mData: 'customer_type_created_date'},
                        { mData: 'recorder'},
                ...
                $('#table-table').on('click', 'td .delete', function(e) {
                    ...
                    var href='<?php echo site_url("Customer_type/delete") ?>' +"/"+ id;
                ...
                $('#table-table').on('click', 'td .edit', function(e) {
                    e.preventDefault()
                    var id = $(this).closest('tr').find('td:first').html();
                    var href='<?php echo site_url("Customer_type/edit_load") ?>' +"/"+ id;
