...
<html>
    ...
    <body>
        <div class="container">
            <form action="<?php echo site_url("customer_type/save"); ?>" method="post">    
                        ...
                        <div class="col-md-12">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-custom text_input" type="text" name="txt_customer_typename" id="txt_customer_typename" required>
