          ...
          <td style="vertical-align: central;">
            <div id="navigation">
              <ul style="list-style-type: none;">
                ...
                ?>
                <li>
                  <input type="submit" permission_name="btnsbumit" class="btn btn-srieng" id="btnsubmit" value="<?php echo $btn_update; ?>" style="border: solid #000000 0px;float:right;" <?php echo $permission_edit;?>/>
                </li>
              </ul>
            </div>
          </td>
