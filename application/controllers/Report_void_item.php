...
class Report_void_item extends CI_Controller {
    ...
    public function index() {
        ...
        $data['page'] = "report/report_sale/report_void_item";
    ...
    public function response() {
        ...
        $data['records'] = $this->Base_model->loadToListJoin('CALL p_void_item_list("'.$query.'")');
