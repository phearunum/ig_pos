<?php
class Table_order_offline extends CI_Controller{
    ...
    public function get_floor_table_layout(){
        ...
        foreach ($appointment as $i) {
            ...
            $detail = $this->Base_model->loadToListJoin("select layout_id,floor_id,layout_name,layout_location_x,layout_location_y,layout_type,`get_table_status`(`floor_table_layout`.`layout_id`) AS `table_status` from floor_table_layout where floor_id=$i->floor_id and status=1");
    ...
    public function order_list_cash_out(){
        ...
        $Stock = $this->Base_model->loadStoreProcedure("call p_sale_cut_stock(".$cash_id.")");
