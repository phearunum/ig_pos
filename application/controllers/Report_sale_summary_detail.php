...
class Report_sale_summary_detail extends CI_Controller {
    ...
    public function index() {
        ...
        $data['page']   = "report/report_sale/report_sale_summary_detail";
    ...
    public function response(){
        $query ="and date_format(sm.sale_master_end_date,'%Y-%m-%d') between CURDATE() and CURDATE() and `sm`.sale_master_member_pay!=0";
        if($this->Base_model->is_supper_user()==false)
    ...
    public function responses(){
        ...
        ///
        $query =" and `sm`.sale_master_member_pay!=0 ";
